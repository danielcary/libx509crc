...
def run():
    urllib.urlretrieve("https://www.gstatic.com/ct/log_list/log_list.json", "log_list.json")
    with open("log_list.json", "rb") as f:
        json_data = f.read()
        
    parsed_json = json.loads(json_data)
    generate_openssl_conf(parsed_json, "log_list.cnf")
